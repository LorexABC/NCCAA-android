 ...
 * Same Add CME module
 */
public class Edit_CME extends AppCompatActivity {

    private TextView cmeTextTV, cmeTitle;
    ...
    private String mUploadID = "", mYear = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        session = new UserSession(Edit_CME.this);
        requestQueue = Volley.newRequestQueue(Edit_CME.this);//Creating the RequestQueue

        TextView uploadCertification = (TextView) findViewById(R.id.add_CME_Btn);
        uploadCertification.setText("Uploaded");
            ...
            public void onClick(View v) {
                if(uploadCertification.getText() == "Uploaded") {
                    ...
                    try {
                        ...
                        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(Edit_CME.this);
        ...
        cmeTitle = findViewById(R.id.cmeTitle);

        cmeTitle.setText("Edit CME");
        ...
        cmeTextTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Edit_CME.this, More_Info_Cert_Exam.class)
        ...
        SelectCitySpinner adapter = new SelectCitySpinner(Edit_CME.this, android.R.layout.simple_spinner_item, cme_provider_ArrayList);
        ...
        for (int i = 0; i < cme_provider_ArrayList.size(); i++){
            if (cme_provider_ArrayList.get(i).getName().equals(getIntent().getStringExtra("cmeProvider"))){
                cme_provider_Spinner.setSelection(i);
            }
        }

        mUploadID = getIntent().getStringExtra("uploadId");
        mDocument_name.setText(getIntent().getStringExtra("name"));
        mHours.setText(getIntent().getStringExtra("hours"));
        mYear = getIntent().getStringExtra("mYear");

        if (getIntent().getStringExtra("type").equals("anesthesia")){
        ...
        findViewById(R.id.mAdd_CME).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mUploadID.equals("")){
                    Toast.makeText(Edit_CME.this,"Please select File / Take Photo",Toast.LENGTH_LONG).show();
                } else if(mDocument_name.getText().toString().equals("")){
                    Toast.makeText(Edit_CME.this,"Please Enter Document Name",Toast.LENGTH_LONG).show();
                }else if(mHours.getText().toString().equals("")){
                    Toast.makeText(Edit_CME.this,"Please Enter Hours",Toast.LENGTH_LONG).show();
                }else if(mCME_Provider_ID.equals("")){
                    Toast.makeText(Edit_CME.this,"Please Enter CME Provider",Toast.LENGTH_LONG).show();
                }else if(!mChk_bx_1.isChecked() || !mChk_bx_2.isChecked()){
                    Toast.makeText(Edit_CME.this,"Please Check Both Box...",Toast.LENGTH_LONG).show();
                }else{
                    EditHandler(mDocument_name.getText().toString(), mHours.getText().toString(), mCME_Provider_ID, mUploadID, mType, getIntent().getStringExtra("id"));
                }
            }
        });
    }
    ...
    /**
     * Lifecycle function caller (Dialog)
     */
    private void selectImageAndDocument() {
        try {
            ...
            checkAndRequestPermissions();
            Toast.makeText(Edit_CME.this, "Permission error", Toast.LENGTH_LONG).show();
            e.printStackTrace();
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_CAMERA) { // Pick up a image(certificate) from camera
            try {
        ...
        } else if (requestCode == PICK_IMAGE_GALLERY) { // Pick up a image(certificate) from gallery
        ...
        } else if (requestCode == PICK_DOCUMENT) { // Pick up a image(certificate) from document
    ...
    /**
     * Get File file from URI
     * @param uri
     * @return Stringg filename
     *
     * Created by phantom
     * On 03/22/24
     */
     ...
     * On 03/22/24
     */
    public String getFileType(Uri uri) { // Get file type from uri
    ...
    /**
     * Validation file type and size based on definition
     * For instance, limit of file size is 25M and file type is allowed only document and image type
     * @param uri
     * @param allowedTypes
    ...
    public boolean validationFileTypeAndFileSize(Uri uri, String allowedTypes) {
        ...
        if(getFileSize(uri) > 1024 * 1024 * 25) { // file size validation
            Toast.makeText(Edit_CME.this, "The maximum file size must be 25M or less.",
        ...
        Toast.makeText(Edit_CME.this, "Not matched file type. (You must input only "
                + allowedTypes + " file.)",
                Toast.LENGTH_LONG).show();
    ...
    private boolean checkAndRequestPermissions() {
        int camera = ContextCompat.checkSelfPermission(Edit_CME.this,
                Manifest.permission.CAMERA);
        int wtite = ContextCompat.checkSelfPermission(Edit_CME.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
        int read = ContextCompat.checkSelfPermission(Edit_CME.this, Manifest.permission.READ_EXTERNAL_STORAGE);
        ...
        if (!listPermissionsNeeded.isEmpty()) {
            ActivityCompat.requestPermissions(Edit_CME.this, listPermissionsNeeded.toArray(new String[listPermissionsNeeded.size()]), REQUEST_ID_MULTIPLE_PERMISSIONS);
            return false;
        }
        return true;
    }
    ...
    /**
     * Lifecycle function for get result of granting of permissions
...
//                        // shouldShowRequestPermissionRationale will return true
                        ...
                        if (ActivityCompat.shouldShowRequestPermissionRationale(Edit_CME.this,
                                Manifest.permission.WRITE_EXTERNAL_STORAGE) ||
                                ActivityCompat.shouldShowRequestPermissionRationale(Edit_CME.this, Manifest.permission.CAMERA) ||
                                ActivityCompat.shouldShowRequestPermissionRationale(Edit_CME.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                        ...
                        //shouldShowRequestPermissionRationale will return false
                            ...
                            Toast.makeText(Edit_CME.this, getResources().getString(R.string.go_to_enable), Toast.LENGTH_LONG)
                                    .show();
                            //                            //proceed with logic by disabling the related features or quit the app.
                        }
                    }
    ...
    private void showDialogOK(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(Edit_CME.this)
                .setMessage(message)
    ...
    /**
     * Upload certificate from selected image(document)
     * Calling API
     * @param Document
     * @param bitmap
     * @param Name
    ...
    private void UploadData(Uri Document, Bitmap bitmap, String Name) {
        final KProgressHUD progressDialog = KProgressHUD.create(Edit_CME.this)
                    ...
                    new Response.Listener<NetworkResponse>() {
                        ...
                        public void onResponse(NetworkResponse response) {
                            ...
                            try {
                                ...
                                Toast.makeText(Edit_CME.this, e.getMessage(), Toast.LENGTH_LONG).show();
                            }
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            if (error instanceof ServerError) {
                                if (error.networkResponse != null && error.networkResponse.data != null) {
                                    switch (error.networkResponse.statusCode) {
                                        case 500:
                                            ...
                                            if (json != null) {
                                                Toast.makeText(Edit_CME.this, json, Toast.LENGTH_LONG).show();
                                            }
                                            break;
                                    }
                                    //Additional cases
                                ...
                                Toast.makeText(Edit_CME.this, "Connection Timed Out", Toast.LENGTH_LONG).show();
                            else if (error instanceof NetworkError)
                                Toast.makeText(Edit_CME.this, "Bad Network Connection", Toast.LENGTH_LONG).show();
    ...
    /**
     * Edit handler from modified information from user handling on display
     * Calling API
     *
     * @param name
     * @param hours
     ...
     * On 03/22/24
     */
    private void EditHandler(String name, String hours, String cmeProvider, String uploadId, String type, String id) {
        final KProgressHUD progressDialog = KProgressHUD.create(Edit_CME.this)
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.PUT, session.BASEURL + "users/me/cmeCycles/" + mYear + "/entries/" + id, object,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        Toast.makeText(Edit_CME.this, "Update Successfully.", Toast.LENGTH_LONG).show();

                        Intent intent = new Intent(Edit_CME.this, CME_Submissions.class);
    ...
    /**
     * Create loading system while update this activity
     *
     * Created by phantom
     * On 03/22/24
     */
